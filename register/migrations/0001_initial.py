    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_name', models.CharField(max_length=50, verbose_name='Departamento:')),
                ('indicative', models.IntegerField(verbose_name='Indicativo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_surnames', models.CharField(max_length=50, verbose_name='Primer Apellidos:')),
                ('last_surnames', models.CharField(max_length=50, verbose_name='Segundo Apellidos:')),
                ('direction', models.CharField(max_length=50, verbose_name='Dirección:')),
                ('tel_number', models.IntegerField(blank=True, verbose_name='Teléfono Fijo')),
                ('cel_number', models.IntegerField(blank=True, verbose_name='Teléfono Celular')),
