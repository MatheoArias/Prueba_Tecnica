...
# from .serializers import CitizenSerializers
...
def deletecitizen(request, citizen_id):
    ...
    citizen.delete()
    messages.success(
        request, f'Usted eliminó a: {citizen.first_name} {citizen.last_name} {citizen.first_surnames}{citizen.last_surnames} con Cédula {citizen.cc}')
    return redirect('register:add')
# """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
def addspace(request):
    ...
    if formstate.is_valid():
        formstate.save()
        messages.success(
            request, f'Usted Acaba de agregar una ciudad con éxito')
        return redirect('register:addspace')
    else:
        formstate = FormState()
