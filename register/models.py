...
class City(models.Model):
    state=models.ForeignKey(State,verbose_name="Departamento",blank=False,on_delete=models.CASCADE)
    city_name=models.CharField(("Ciudad"),max_length=50,blank=False,unique=True)
